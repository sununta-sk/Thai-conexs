...
{/* HIDDEN:       <SectionTitle>{tx.faceVerify}</SectionTitle> */}
{/* HIDDEN:       {isVerified ? ( */}
{/* HIDDEN:         <div style={{ background: 'rgba(34, 197, 94, 0.1)', border: '1.5px solid #22c55e', borderRadius: '16px', padding: '16px', display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}> */}
{/* HIDDEN:           <span style={{ fontSize: '28px' }}>✅</span> */}
{/* HIDDEN:           <div> */}
{/* HIDDEN:             <div style={{ fontWeight: 'bold', color: '#4ade80', fontSize: '15px' }}>{tx.verifiedTitle}</div> */}
{/* HIDDEN:             <div style={{ fontSize: '13px', color: '#86efac' }}>{tx.verifiedSub}</div> */}
{/* HIDDEN:           </div> */}
{/* HIDDEN:         </div> */}
{/* HIDDEN:       ) : ( */}
{/* HIDDEN:         <div style={{ background: 'rgba(234, 179, 8, 0.1)', border: '1.5px solid #eab308', borderRadius: '16px', padding: '16px', marginBottom: '20px' }}> */}
{/* HIDDEN:           <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '12px' }}> */}
{/* HIDDEN:             <span style={{ fontSize: '24px' }}>⚠️</span> */}
{/* HIDDEN:             <div> */}
{/* HIDDEN:               <div style={{ fontWeight: 800, color: '#f1f5f9', fontSize: '15px', marginBottom: 6 }}>{tx.notVerifiedTitle}</div> */}
{/* HIDDEN:               <div style={{ fontSize: '13px', color: '#94a3b8', lineHeight: 1.6 }}>{tx.notVerifiedSub}</div> */}
{/* HIDDEN:             </div> */}
{/* HIDDEN:           </div> */}
{/* HIDDEN:           {cameraOpen && ( */}
{/* HIDDEN:             <div style={{ marginBottom: '12px', borderRadius: '12px', overflow: 'hidden', position: 'relative', background: '#000' }}> */}
{/* HIDDEN:               <video ref={videoRef} autoPlay playsInline muted style={{ width: '100%', display: 'block', borderRadius: '12px' }} /> */}
{/* HIDDEN:               <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: '160px', height: '160px', borderRadius: '50%', border: '3px solid rgba(255,255,255,0.8)', pointerEvents: 'none' }} /> */}
{/* HIDDEN:               <div style={{ position: 'absolute', bottom: 8, left: 0, right: 0, textAlign: 'center', color: '#fff', fontSize: '12px', opacity: 0.8 }}>วางใบหน้าให้อยู่ในวงกลม</div> */}
{/* HIDDEN:             </div> */}
{/* HIDDEN:           )} */}
{/* HIDDEN:           {capturedImage && !cameraOpen && ( */}
{/* HIDDEN:             <div style={{ textAlign: 'center', marginBottom: '12px' }}> */}
{/* HIDDEN:               <img src={capturedImage} style={{ width: '120px', height: '120px', borderRadius: '60px', objectFit: 'cover', border: '3px solid #fbbf24' }} /> */}
{/* HIDDEN:             </div> */}
{/* HIDDEN:           )} */}
{/* HIDDEN:           {cameraError && <div style={{ background: 'rgba(239, 68, 68, 0.15)', borderRadius: '10px', padding: '10px', marginBottom: '10px', color: '#f87171', fontSize: '13px', textAlign: 'center' }}>❌ {cameraError}</div>} */}
{/* HIDDEN:           {verifyResult === 'pass' && <div style={{ background: 'rgba(34, 197, 94, 0.15)', borderRadius: '10px', padding: '10px', marginBottom: '10px', color: '#4ade80', fontSize: '13px', fontWeight: 'bold', textAlign: 'center' }}>✅ {verifyMessage}</div>} */}
{/* HIDDEN:           {verifyResult === 'fail' && <div style={{ background: 'rgba(239, 68, 68, 0.15)', borderRadius: '10px', padding: '10px', marginBottom: '10px', color: '#f87171', fontSize: '13px', fontWeight: 'bold', textAlign: 'center' }}>❌ {verifyMessage}</div>} */}
{/* HIDDEN:           {!cameraOpen && !capturedImage && ( */}
{/* HIDDEN:             <button onClick={openCamera} style={{ width: '100%', padding: '13px', borderRadius: '12px', border: 'none', background: 'linear-gradient(135deg, #e91e63, #c2185b)', color: '#fff', fontWeight: 'bold', fontSize: '15px', cursor: 'pointer' }}> */}
{/* HIDDEN:               📷 Open Camera */}
{/* HIDDEN:             </button> */}
{/* HIDDEN:           )} */}
{/* HIDDEN:           {cameraOpen && ( */}
{/* HIDDEN:             <div style={{ display: 'flex', gap: '10px' }}> */}
{/* HIDDEN:               <button onClick={capturePhoto} style={{ flex: 1, padding: '13px', borderRadius: '12px', border: 'none', background: 'linear-gradient(135deg, #f59e0b, #ef4444)', color: '#fff', fontWeight: 'bold', fontSize: '15px', cursor: 'pointer' }}>📸 ถ่ายภาพ</button> */}
{/* HIDDEN:               <button onClick={closeCamera} style={{ padding: '13px 16px', borderRadius: '12px', border: '1px solid #334155', background: '#0f172a', color: '#94a3b8', fontWeight: 'bold', cursor: 'pointer' }}>ยกเลิก</button> */}
{/* HIDDEN:             </div> */}
{/* HIDDEN:           )} */}
{/* HIDDEN:           {capturedImage && !cameraOpen && ( */}
{/* HIDDEN:             <div style={{ display: 'flex', gap: '10px' }}> */}
{/* HIDDEN:               <button onClick={handleVerify} disabled={verifying} style={{ flex: 1, padding: '13px', borderRadius: '12px', border: 'none', background: verifying ? '#334155' : 'linear-gradient(135deg, #f59e0b, #ef4444)', color: '#fff', fontWeight: 'bold', fontSize: '15px', cursor: verifying ? 'not-allowed' : 'pointer' }}> */}
{/* HIDDEN:                 {verifying ? tx.verifyingBtn : tx.verifyBtn} */}
{/* HIDDEN:               </button> */}
{/* HIDDEN:               <button onClick={openCamera} style={{ padding: '13px 16px', borderRadius: '12px', border: '1px solid #334155', background: '#0f172a', color: '#94a3b8', fontWeight: 'bold', cursor: 'pointer' }}>🔄 ถ่ายใหม่</button> */}
{/* HIDDEN:             </div> */}
{/* HIDDEN:           )} */}
{/* HIDDEN:         </div> */}
{/* HIDDEN:       )} */}
