...
export default function Login() {
  ...
  // ── ดึง avatar_url จาก profiles (มี avatar เท่านั้น) ──────────────────────
  useEffect(() => {
    supabase
      .from('profiles')
      .select('avatar_url')
    ...
    <div style={S.page}>
      ...
      <div style={S.slideWrap}>
        ...
        {photos.length > 0 ? (
          ...
          // fallback gradient ถ้ายังไม่มีรูป
      ...
      <div style={S.formWrap}>
        <div style={S.formInner}>
          ...
          <p style={S.signupText}>
            ...
            <Link to="/register" style={S.signupLink}>Sign Up</Link>
          </p>
        </div>
      </div>
...
const S = {
  ...
  slideFallback: {
    position: 'absolute',
    inset: 0,
    background: 'linear-gradient(135deg, #e91e6388 0%, #1a1a2e 100%)',
  },
  slideOverlay: {
    position: 'absolute',
    inset: 0,
