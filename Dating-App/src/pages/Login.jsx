    ...
    supabase
      ...
      .then(({ data }) => {
        if (data && data.length > 0) {
          ...
          setPhotos(shuffled.map(p => p.avatar_url))
        }
      })
  }, [])
      ...
      <div style={S.formWrap}>
        <div style={S.formInner}>
          ...
          <form onSubmit={handleLogin} style={S.form}>
            ...
            <div style={S.divider}><hr style={S.hr} /><span style={S.orText}R</span><hr style={S.hr} /></div>
...
const S = {
  ...
  brandTitle: { color: '#fff', fontSize: '32px', fontWeight: 800, letterSpacing: '-0.5px', textShadow: '0 2px 12px rgba(0,0,0,0.4)' },
  ...
  dot: { width: '7px', height: '7px', borderRadius: '50%', background: 'rgba(255,255,255,0.4)', border: 'none', cursor: 'pointer', padding: 0, transition: 'background 0.3s, transform 0.3s' },
