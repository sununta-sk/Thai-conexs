...
const T = {
  ...
  // ─────────────────────────────────────────────
  common: {
    th: { save:'บันทึก', cancel:'ยกเลิก', confirm:'ยืนยัน', back:'ย้อนกลับ', loading:'กำลังโหลด...', error:'เกิดข้อผิดพลาด', success:'สำเร็จ', submit:'ส่ง', search:'ค้นหา', close:'ปิด', delete:'ลบ', edit:'แก้ไข', view:'ดู', logout:'ออกจากระบบ', online:'ออนไลน์', offline:'ออฟไลน์', yes:'ใช่', no:'ไม่', send:'ส่ง', sending:'กำลังส่ง...', retry:'ลองใหม่', admin:'แอดมิน', upgradeAccount:'อัพเกรด', editProfile:'แก้ไขโปรไฟล์', boostProfile:'Boost โปรไฟล์', vipMember:'สมาชิก VIP', accountSettings:'ตั้งค่าบัญชี', help:'ช่วยเหลือ', notifications:'การแจ้งเตือน', discoverNav:'ค้นพบ', messagesNav:'ข้อความ', mobilePreview:'ดูแบบมือถือ', },
    en: { save:'Save', cancel:'Cancel', confirm:'Confirm', back:'Back', loading:'Loading...', error:'Error', success:'Success', submit:'Submit', search:'Search', close:'Close', delete:'Delete', edit:'Edit', view:'View', logout:'Logout', online:'Online', offline:'Offline', yes:'Yes', no:'No', send:'Send', sending:'Sending...', retry:'Retry', admin:'Admin', upgradeAccount:'Upgrade Account', editProfile:'Edit Profile', boostProfile:'Boost Profile', vipMember:'VIP Member', accountSettings:'Account Settings', help:'Help', notifications:'Notifications', discoverNav:'Discover', messagesNav:'Messages', mobilePreview:'Mobile Preview', },
    ...
    fr: { save:'Enregistrer', cancel:'Annuler', confirm:'Confirmer', back:'Retour', loading:'Chargement...', error:'Erreur', success:'Succès', submit:'Soumettre', search:'Rechercher', close:'Fermer', delete:'Supprimer', edit:'Modifier', view:'Voir', logout:'Déconnexion', online:'En ligne', offline:'Hors ligne', yes:'Oui', no:'Non', send:'Envoyer', sending:'Envoi...', retry:'Réessayer', admin:'Admin', upgradeAccount:'Passer Premium', editProfile:'Modifier le profil', accountSettings:'Paramètres du compte', help:'Aide', notifications:'Notifications', discoverNav:'Découvrir', messagesNav:'Messages', mobilePreview:'Aperçu Mobile', },
    de: { save:'Speichern', cancel:'Abbrechen', confirm:'Bestätigen', back:'Zurück', loading:'Laden...', error:'Fehler', success:'Erfolg', submit:'Senden', search:'Suchen', close:'Schließen', delete:'Löschen', edit:'Bearbeiten', view:'Ansehen', logout:'Abmelden', online:'Online', offline:'Offline', yes:'Ja', no:'Nein', send:'Senden', sending:'Senden...', retry:'Wiederholen', admin:'Admin', upgradeAccount:'Upgrade', editProfile:'Profil bearbeiten', accountSettings:'Kontoeinstellungen', help:'Hilfe', notifications:'Benachrichtigungen', discoverNav:'Entdecken', messagesNav:'Nachrichten', mobilePreview:'Mobile-Vorschau', },
    es: { save:'Guardar', cancel:'Cancelar', confirm:'Confirmar', back:'Volver', loading:'Cargando...', error:'Error', success:'Éxito', submit:'Enviar', search:'Buscar', close:'Cerrar', delete:'Eliminar', edit:'Editar', view:'Ver', logout:'Cerrar sesión', online:'En línea', offline:'Desconectado', yes:'Sí', no:'No', send:'Enviar', sending:'Enviando...', retry:'Reintentar', admin:'Admin', upgradeAccount:'Mejorar Cuenta', editProfile:'Editar perfil', accountSettings:'Configuración', help:'Ayuda', notifications:'Notificaciones', discoverNav:'Descubrir', messagesNav:'Mensajes', mobilePreview:'Vista Móvil', },
    it: { save:'Salva', cancel:'Annulla', confirm:'Conferma', back:'Indietro', loading:'Caricamento...', error:'Errore', success:'Successo', submit:'Invia', search:'Cerca', close:'Chiudi', delete:'Elimina', edit:'Modifica', view:'Visualizza', logout:'Esci', online:'Online', offline:'Offline', yes:'Sì', no:'No', send:'Invia', sending:'Invio...', retry:'Riprova', admin:'Admin', upgradeAccount:'Aggiorna Account', editProfile:'Modifica profilo', accountSettings:'Impostazioni', help:'Aiuto', notifications:'Notifiche', discoverNav:'Scopri', messagesNav:'Messaggi', mobilePreview:'Anteprima Mobile', },
    pt: { save:'Salvar', cancel:'Cancelar', confirm:'Confirmar', back:'Voltar', loading:'Carregando...', error:'Erro', success:'Sucesso', submit:'Enviar', search:'Pesquisar', close:'Fechar', delete:'Excluir', edit:'Editar', view:'Ver', logout:'Sair', online:'Online', offline:'Offline', yes:'Sim', no:'Não', send:'Enviar', sending:'Enviando...', retry:'Tentar novamente', admin:'Admin', upgradeAccount:'Atualizar Conta', editProfile:'Editar perfil', accountSettings:'Configurações', help:'Ajuda', notifications:'Notificações', discoverNav:'Descobrir', messagesNav:'Mensagens', mobilePreview:'Visualização Móvel', },
    ru: { save:'Сохранить', cancel:'Отмена', confirm:'Подтвердить', back:'Назад', loading:'Загрузка...', error:'Ошибка', success:'Успех', submit:'Отправить', search:'Поиск', close:'Закрыть', delete:'Удалить', edit:'Изменить', view:'Просмотр', logout:'Выйти', online:'Онлайн', offline:'Не в сети', yes:'Да', no:'Нет', send:'Отправить', sending:'Отправка...', retry:'Повторить', admin:'Админ', upgradeAccount:'Улучшить', editProfile:'Изменить профиль', accountSettings:'Настройки', help:'Помощь', notifications:'Уведомления', discoverNav:'Открыть', messagesNav:'Сообщения', mobilePreview:'Мобильный просмотр', },
    ar: { save:'حفظ', cancel:'إلغاء', confirm:'تأكيد', back:'رجوع', loading:'جار التحميل...', error:'خطأ', success:'نجاح', submit:'إرسال', search:'بحث', close:'إغلاق', delete:'حذف', edit:'تعديل', view:'عرض', logout:'تسجيل الخروج', online:'متصل', offline:'غير متصل', yes:'نعم', no:'لا', send:'إرسال', sending:'جار الإرسال...', retry:'إعادة المحاولة', admin:'مسؤول', upgradeAccount:'ترقية الحساب', editProfile:'تعديل الملف', accountSettings:'إعدادات الحساب', help:'مساعدة', notifications:'الإشعارات', discoverNav:'اكتشف', messagesNav:'الرسائل', mobilePreview:'معاينة الجوال', },
    hi: { save:'सहेजें', cancel:'रद्द करें', confirm:'पुष्टि करें', back:'वापस', loading:'लोड हो रहा है...', error:'त्रुटि', success:'सफलता', submit:'जमा करें', search:'खोजें', close:'बंद करें', delete:'हटाएं', edit:'संपादित करें', view:'देखें', logout:'लॉग आउट', online:'ऑनलाइन', offline:'ऑफलाइन', yes:'हाँ', no:'नहीं', send:'भेजें', sending:'भेजा जा रहा है...', retry:'पुनः प्रयास', admin:'एडमिन', upgradeAccount:'अकाउंट अपग्रेड', editProfile:'प्रोफाइल एडिट', accountSettings:'अकाउंट सेटिंग्स', help:'सहायता', notifications:'सूचनाएं', discoverNav:'खोजें', messagesNav:'संदेश', mobilePreview:'मोबाइल पूर्वावलोकन', },
  ...
  // ─────────────────────────────────────────────
  // BOOST MODAL (BoostModal.jsx)
  // ─────────────────────────────────────────────
  boostModal: {
    th: {
      subtitleLine1: 'ขึ้นอันดับต้นใน Discover & Search',
      subtitleLine2: 'ให้คนเห็นคุณมากขึ้น',
      hours1: '1 ชั่วโมง', hours6: '6 ชั่วโมง', hours24: '24 ชั่วโมง',
      descTry: 'ลองใช้งาน', descRecommended: 'แนะนำ ⭐', descMax: 'สูงสุด',
      popular: 'ยอดนิยม',
      infoRank: 'โปรไฟล์ของคุณจะปรากฏอันดับต้นๆ ของทุกคน',
      infoSubscription: 'ต้องมี Subscription plan เพื่อใช้ฟีเจอร์นี้',
      infoExpiry: 'Boost จะหมดอายุอัตโนมัติตาม duration ที่เลือก',
      startCta: 'เริ่ม Boost เลย',
      activeLabel: 'Boost กำลังทำงาน',
      activeHint: 'โปรไฟล์ของคุณอยู่อันดับต้นของ Discover แล้ว ✨',
    },
    en: {
      subtitleLine1: 'Rank at the top of Discover & Search',
      subtitleLine2: 'Get seen by more people',
      hours1: '1 hour', hours6: '6 hours', hours24: '24 hours',
      descTry: 'Try it out', descRecommended: 'Recommended ⭐', descMax: 'Maximum',
      popular: 'Popular',
      infoRank: 'Your profile will appear at the top for everyone',
      infoSubscription: 'Requires a subscription plan to use this feature',
      infoExpiry: 'Boost expires automatically based on the duration you choose',
      startCta: 'Start Boost Now',
      activeLabel: 'Boost Active',
      activeHint: 'Your profile is now at the top of Discover ✨',
    },
  },
  ...
  // ─────────────────────────────────────────────
  discover: {
    th: { title:'ค้นพบ', noUsers:'ไม่มีผู้ใช้ออนไลน์', onlineUsers:'ผู้ใช้ออนไลน์', sendMessage:'ส่งข้อความ', viewProfile:'ดูโปรไฟล์', filters:'ตัวกรอง', gender:'เพศ', ageRange:'ช่วงอายุ', country:'ประเทศ', province:'จังหวัด', agePref:'ช่วงอายุที่ต้องการ', applyFilters:'ใช้ตัวกรอง', genderAll:'ชาย & หญิง', genderMale:'ชาย', genderFemale:'หญิง', genderTransgender:'ทรานส์เจนเดอร์', genderOther:'อื่นๆ', allAges:'ทุกช่วงอายุ', allCountries:'ทุกประเทศ', allProvinces:'ทุกจังหวัด', respectAgePref:'เคารพช่วงอายุที่ต้องการ', ignoreAgePref:'ไม่สนใจช่วงอายุ', anyEducation:'การศึกษา — ทั้งหมด', anyHeight:'ส่วนสูง — ทั้งหมด', anyWeight:'น้ำหนัก — ทั้งหมด', anyChildren:'บุตร — ทั้งหมด', heightUnder150:'ต่ำกว่า 150 ซม.', height150_160:'150–160 ซม.', height161_170:'161–170 ซม.', height171_180:'171–180 ซม.', height181Plus:'สูงกว่า 180 ซม.', weightUnder50:'ต่ำกว่า 50 กก.', weight50_60:'50–60 กก.', weight61_70:'61–70 กก.', weight71_80:'71–80 กก.', weight81Plus:'มากกว่า 80 กก.', eduHighSchool:'มัธยม', eduBachelor:'ปริญญาตรี', eduMaster:'ปริญญาโท', eduPhD:'ปริญญาเอก', childNo:'ไม่มีบุตร', childHas:'มีบุตรแล้ว', childWant:'อยากมีบุตร', childDontWant:'ไม่ต้องการบุตร', onlineOnly:'ออนไลน์เท่านั้น', hasPhotoOnly:'มีรูป', orderLastActive:'เรียงตามใช้งานล่าสุด', orderNewest:'เรียงตามใหม่สุด', orderRandom:'เรียงแบบสุ่ม', memberCount:'{shown} จาก {total} คน', noMembersFound:'ไม่พบสมาชิก', noMatchesAdjust:'ไม่พบผลลัพธ์ ลองปรับตัวกรอง', loadingMembers:'กำลังโหลด...', rightNow:'ออนไลน์', agoMinutes:'{n} นาทีที่แล้ว', agoHours:'{n} ชั่วโมงที่แล้ว', agoDays:'{n} วันที่แล้ว', chatBtn:'แชท', hideBtn:'ปิด', },
    en: { title:'Discover', noUsers:'No users online', onlineUsers:'Online Users', sendMessage:'Send Message', viewProfile:'View Profile', filters:'Filters', gender:'Gender', ageRange:'Age Range', country:'Country', province:'Province', agePref:'Age Preference', applyFilters:'Apply Filters', genderAll:'Guys & Girls', genderMale:'Guys', genderFemale:'Girls', genderTransgender:'Transgender', genderOther:'Other', allAges:'All ages', allCountries:'All countries', allProvinces:'All provinces', respectAgePref:'Respect their age range', ignoreAgePref:'Ignore their age range', anyEducation:'Any education', anyHeight:'Any height', anyWeight:'Any weight', anyChildren:'Any children', heightUnder150:'Under 150 cm', height150_160:'150-160 cm', height161_170:'161-170 cm', height171_180:'171-180 cm', height181Plus:'Over 180 cm', weightUnder50:'Under 50 kg', weight50_60:'50-60 kg', weight61_70:'61-70 kg', weight71_80:'71-80 kg', weight81Plus:'Over 80 kg', eduHighSchool:'High School', eduBachelor:'Bachelor', eduMaster:'Master', eduPhD:'PhD', childNo:'No children', childHas:'Has children', childWant:'Want children', childDontWant:"Don't want children", onlineOnly:'Online only', hasPhotoOnly:'Has photo', orderLastActive:'Sort by Last Active', orderNewest:'Sort by Newest', orderRandom:'Sort by Random', memberCount:'{shown} of {total} members', noMembersFound:'No members found', noMatchesAdjust:'No matches. Try adjusting your filters.', loadingMembers:'Loading...', rightNow:'Right now', agoMinutes:'{n}m ago', agoHours:'{n}h ago', agoDays:'{n}d ago', chatBtn:'Chat', hideBtn:'Hide', },
  ...
  // ─────────────────────────────────────────────
  userProfile: {
    th: { back:'← กลับ', sendMessage:'💬 ส่งข้อความ', aboutMe:'เกี่ยวกับฉัน', generalInfo:'ข้อมูลทั่วไป', online:'ออนไลน์อยู่', justNow:'เพิ่งออนไลน์', minAgo:(n)=>`${n} นาทีที่แล้ว`, hrAgo:(n)=>`${n} ชั่วโมงที่แล้ว`, dayAgo:(n)=>`${n} วันที่แล้ว`, notFound:'ไม่พบโปรไฟล์นี้', verified:'✓ ยืนยันแล้ว', interests:'ความสนใจ', photos:'รูปภาพ', noName:'ไม่ระบุชื่อ', showMore:'...เพิ่มเติม', showLess:'แสดงน้อยลง', getMoreLotus:'รับดอกบัวเพิ่ม', lotusComingSoonTitle:'เร็วๆ นี้', lotusComingSoonBody:'ระบบดอกบัวกำลังจะมาเร็วๆ นี้', },
    en: { back:'← Back', sendMessage:'💬 Send Message', aboutMe:'About Me', generalInfo:'General Info', online:'Online', justNow:'Just now', minAgo:(n)=>`${n}m ago`, hrAgo:(n)=>`${n}h ago`, dayAgo:(n)=>`${n}d ago`, notFound:'Profile not found', verified:'✓ Verified', interests:'Interests', photos:'Photos', noName:'No name set', showMore:'...more', showLess:'Show less', getMoreLotus:'Get more lotus', lotusComingSoonTitle:'Coming soon', lotusComingSoonBody:'The lotus system is coming soon', },
    zh: { back:'← 返回', sendMessage:'💬 发送消息', aboutMe:'关于我', generalInfo:'基本信息', online:'在线', justNow:'刚刚在线', minAgo:(n)=>`${n}分钟前`, hrAgo:(n)=>`${n}小时前`, dayAgo:(n)=>`${n}天前`, notFound:'找不到此用户', verified:'✓ 已认证', },
    ja: { back:'← 戻る', sendMessage:'💬 メッセージを送る', aboutMe:'自己紹介', generalInfo:'基本情報', online:'オンライン', justNow:'たった今', minAgo:(n)=>`${n}分前`, hrAgo:(n)=>`${n}時間前`, dayAgo:(n)=>`${n}日前`, notFound:'プロフィールが見つかりません', verified:'✓ 認証済み', },
    ko: { back:'← 뒤로', sendMessage:'💬 메시지 보내기', aboutMe:'나에 대해', generalInfo:'기본 정보', online:'온라인', justNow:'방금 온라인', minAgo:(n)=>`${n}분 전`, hrAgo:(n)=>`${n}시간 전`, dayAgo:(n)=>`${n}일 전`, notFound:'프로필을 찾을 수 없습니다', verified:'✓ 인증됨', },
    fr: { back:'← Retour', sendMessage:'💬 Envoyer un message', aboutMe:'À propos de moi', generalInfo:'Informations générales', online:'En ligne', justNow:"À l'instant", minAgo:(n)=>`il y a ${n}min`, hrAgo:(n)=>`il y a ${n}h`, dayAgo:(n)=>`il y a ${n}j`, notFound:'Profil introuvable', verified:'✓ Vérifié', },
    de: { back:'← Zurück', sendMessage:'💬 Nachricht senden', aboutMe:'Über mich', generalInfo:'Allgemeine Infos', online:'Online', justNow:'Gerade online', minAgo:(n)=>`vor ${n}Min`, hrAgo:(n)=>`vor ${n}Std`, dayAgo:(n)=>`vor ${n}T`, notFound:'Profil nicht gefunden', verified:'✓ Verifiziert', },
    es: { back:'← Volver', sendMessage:'💬 Enviar mensaje', aboutMe:'Sobre mí', generalInfo:'Información general', online:'En línea', justNow:'Recién en línea', minAgo:(n)=>`hace ${n}min`, hrAgo:(n)=>`hace ${n}h`, dayAgo:(n)=>`hace ${n}d`, notFound:'Perfil no encontrado', verified:'✓ Verificado', },
    it: { back:'← Indietro', sendMessage:'💬 Invia messaggio', aboutMe:'Su di me', generalInfo:'Informazioni generali', online:'Online', justNow:'Appena online', minAgo:(n)=>`${n}min fa`, hrAgo:(n)=>`${n}h fa`, dayAgo:(n)=>`${n}g fa`, notFound:'Profilo non trovato', verified:'✓ Verificato', },
    pt: { back:'← Voltar', sendMessage:'💬 Enviar mensagem', aboutMe:'Sobre mim', generalInfo:'Informações gerais', online:'Online', justNow:'Acabou de entrar', minAgo:(n)=>`há ${n}min`, hrAgo:(n)=>`há ${n}h`, dayAgo:(n)=>`há ${n}d`, notFound:'Perfil não encontrado', verified:'✓ Verificado', },
    ru: { back:'← Назад', sendMessage:'💬 Написать', aboutMe:'О себе', generalInfo:'Общая информация', online:'Онлайн', justNow:'Только что', minAgo:(n)=>`${n}мин назад`, hrAgo:(n)=>`${n}ч назад`, dayAgo:(n)=>`${n}д назад`, notFound:'Профиль не найден', verified:'✓ Подтверждён', },
    ar: { back:'← رجوع', sendMessage:'💬 إرسال رسالة', aboutMe:'عني', generalInfo:'معلومات عامة', online:'متصل', justNow:'الآن', minAgo:(n)=>`منذ ${n} دقيقة`, hrAgo:(n)=>`منذ ${n} ساعة`, dayAgo:(n)=>`منذ ${n} يوم`, notFound:'الملف الشخصي غير موجود', verified:'✓ موثق', },
    hi: { back:'← वापस', sendMessage:'💬 संदेश भेजें', aboutMe:'मेरे बारे में', generalInfo:'सामान्य जानकारी', online:'ऑनलाइन', justNow:'अभी', minAgo:(n)=>`${n} मिनट पहले`, hrAgo:(n)=>`${n} घंटे पहले`, dayAgo:(n)=>`${n} दिन पहले`, notFound:'प्रोफ़ाइल नहीं मिली', verified:'✓ सत्यापित', },
    vi: { back:'← Quay lại', sendMessage:'💬 Gửi tin nhắn', aboutMe:'Về tôi', generalInfo:'Thông tin chung', online:'Đang online', justNow:'Vừa online', minAgo:(n)=>`${n} phút trước`, hrAgo:(n)=>`${n} giờ trước`, dayAgo:(n)=>`${n} ngày trước`, notFound:'Không tìm thấy hồ sơ', verified:'✓ Đã xác minh', },
  ...
  lotusPage: {
    th: {
      ...
      giftLotus: 'มอบดอกบัว',
      giftSentToast: (n) => `ส่ง ${n} 🪷 แล้ว!`,
      errRecipientNotFound: 'ไม่พบโปรไฟล์นี้แล้ว',
      errCannotGiftSelf: 'คุณไม่สามารถมอบดอกบัวให้ตัวเองได้',
    },
    en: {
      back: '← Back',
      ...
      giftLotus: 'Gift lotus',
      giftSentToast: (n) => `Sent ${n} 🪷!`,
      errRecipientNotFound: 'This profile is no longer available.',
      errCannotGiftSelf: 'You cannot gift lotus to yourself.',
    },
  },
};
...
export function getT(page, lang = 'en') {
  ...
  if (!pageTrans) return {};
  const base = pageTrans.en || {};
  const loc = pageTrans[lang] || {};
  return { ...base, ...loc };
}
